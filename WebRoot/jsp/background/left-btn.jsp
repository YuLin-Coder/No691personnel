    ...
    <div class="row sidebar">
        <div class="col-md-3" id="sidebar" role="navigation">
            <div class="list-group">
                <a href="<%=path %>/dept/list" target="rightFrame" onclick="changeColor(this.id)"
                   class="list-group-item">部门信息管理</a>
                <a href="<%=path %>/post/list" target="rightFrame" onclick="changeColor(this.id)"
                   class="list-group-item">岗位信息管理</a>
                <a href="<%=path %>/user/listMarket" target="rightFrame" onclick="changeColor(this.id)"
                   class="list-group-item">员工入职管理</a>
                <a href="<%=path %>/user/list" target="rightFrame" onclick="changeColor(this.id)"
                   class="list-group-item">员工信息总览</a>
                <a href="<%=path %>/user/listRetire" target="rightFrame" onclick="changeColor(this.id)"
                   class="list-group-item">员工离职管理</a>
                <a href="<%=path %>/salary/list" target="rightFrame" onclick="changeColor(this.id)"
                   class="list-group-item">薪酬信息管理</a>
                <a href="<%=path %>/reward/list" target="rightFrame" onclick="changeColor(this.id)"
                   class="list-group-item">奖惩信息管理</a>
