    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1 main">
            ...
            <div class="table-responsive">
                <form action="<%=path %>/post/edit" method="post">
                        ...
                        <tr>
                            <td>
                                <div class="input-group input-group-md col-md-8">
                                    ...
                                    <input type="text" name="postname" value="${post.postname}" class="form-control"
                                           placeholder="">
                                </div>
                            </td>
                            <td>
                                <div class="input-group input-group-md col-md-8">
                                    <span class="input-group-addon">岗位介绍</span>
                                    <input type="text" name="postdesc" value="${post.postdesc}" class="form-control"
                                           placeholder="">
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <div class="input-group input-group-md col-md-8 has-feedback">
                                    ...
                                    <select class="form-control" id="fkdeptid" name="fkdeptid">
                                        <option value="">请选择</option>
                                        <c:forEach items="${dept.list}" var="dept">
                                            <option value="${dept.deptid}" ${dept.deptid==post.fkdeptid?'selected=selected':''}>${dept.deptname}</option>
                                        </c:forEach>
                                    </select>
