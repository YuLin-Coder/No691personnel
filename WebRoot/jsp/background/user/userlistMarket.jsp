...
<head>
    ...
    <script type="text/javascript">
        ...
        function toUpdate(userid) {
            var ret = window.open("<%=path%>/user/" + userid + "/entry", window, "dialogWidth:800px;dailogHeight:400px;");
            //针对于火狐和谷歌浏览器的操作
            if (ret == undefined) {
                ret = window.returnValue;
            }
...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12 main">
            <h1 class="sub-header">人才市场</h1>
            <div class="table-responsive">
                <div class="alert alert-success" role="alert">
                    <form id="form" class="form-inline" action="<%=path %>/user/listMarket" method="post">
                        <input type="hidden" id="pageNum" name="pageNum" value="${pageNum}">
                        <input class="form-control" type="text" name="username" placeholder="员工用户名">
                        <input class="form-control" placeholder="真实姓名" type="text" name="realname">
                        <input type="submit" value="查找" class="btn btn-success col-md-offset-6">
                        <button type="button" onclick="toAdd()" class="btn btn-success">添加员工</button>
                    </form>
                </div>
                <table class="table table-striped">
                    ...
                    <c:forEach items="${info.list}" var="user" varStatus="vs">
                        <tr>
                            ...
                            <td>
                                <button type="button" onclick="toUpdate('${user.userid}')" class="btn btn-sm btn-info">
                                    入职
                                </button>
