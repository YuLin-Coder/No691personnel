...
<html>
	<head>
  	...
  	<frameset rows="50,*" cols="*" frameborder="no" border="0" framespacing="0">
		<frame src="<%=path %>/jsp/foreground/top-right.jsp" name="topFrame" scrolling="No" noresize="noresize" id="" title="topFrame" />
		<frameset cols="250,*" frameborder="no" border="0" framespacing="0">
			<frame src="<%=path %>/jsp/foreground/left-btn.jsp" name="leftFrame" scrolling="No" noresize="noresize" id="" title="leftFrame" />
			<frame src="<%=path %>/jsp/foreground/right-first.jsp" name="rightFrame" id="" title="rightFrame" />
		</frameset>
	</frameset>
	<body>
