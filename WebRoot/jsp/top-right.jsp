    ...
    <script type="text/javascript">
        function ToOut(obj) {
            if (window.confirm("您去确定要退出该系统吗?")) {
                obj.href = "<%=path%>/servlet/LogoutServlet";//千万不要在=号两端加入空格
                return false;
            }
        }
        function setId() {
...
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="javascript:void(0)">论文审稿系统</a>
        </div>
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
                <li onclick="changeColor(this.id)"><a href="javascript:void(0)">${sessionScope.user.username}，欢迎登陆！</a></li>
                <li onclick="changeColor(this.id)"><a href="<%=path%>/system/logout" target="_parent">安全退出</a>
                </li>
            </ul>
        </div>
    </div>
