...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-10 col-md-offset-1 main">
            <h1 class="sub-header">修改奖惩信息</h1>
            <div class="table-responsive">
                <form action="<%=path %>/reward/edit" method="post">
                                ...
                                <div class="input-group input-group-md col-md-8">
                                    ...
                                    <select class="form-control" name="fkuserid">
                                        ...
                                        <c:forEach items="${user.list}" var="u">
                                            <option value="${u.userid}" ${reward.fkuserid==u.userid?'selected=selected':''} >${u.realname}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                            </td>
                            <td>
                                <div class="input-group input-group-md col-md-8">
                                    ...
                                    <input type="text" name="reason" class="form-control"
                                           placeholder="" value="${reward.reason}">
